...
#
# Purpose:      Phonebook Demo. Demonstratcing OOP, Tkinter, GUI module,
...
def onSelect(self,event):
    ...
    with conn:
        ...
        # This returns a tuple and we can also slice it inot 4 parts using data[] during the iteration
        for data in varBody:
