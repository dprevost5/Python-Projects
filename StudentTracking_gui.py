...
def load_gui(self):
    ...
    # Define the listbok with a scrollbar and grid them
    ...
    self.btn_submit = tk.Button(self.master,width=12,height=2,text="Submit",command=lambda: StudentTracking_func.addToList(self))
